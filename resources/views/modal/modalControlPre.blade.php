<body>
    <div class="modal fade" id="modalcontrolpre" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="width:100%">
                <form  class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label for="inputPassword4" class="form-label">Vitaminas Suministrada</label>
                        <select class="form-control" id="inputPassword4" name="vitaminas">
                    ...
                    <div class="col-md-6">
                        <label for="inputPassword4" class="form-label">Obserbacion</label>
                        <input type="text" class="form-control" id="inputPassword4">
                    </div>
